...
var ApproveLeaveCommentsPage = /** @class */ (function () {
    ...
    ApproveLeaveCommentsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_4__angular_core__["Component"])({
            selector: 'page-approve-leave-comments',template:/*ion-inline-start:"C:\Users\edot3\Documents\Platica-Polinesia\src\pages\approve-leave-comments\approve-leave-comments.html"*/'<ion-content padding class="custom-popup">\n\n\n\n  <ion-card>\n\n    <ion-card-header>{{approveTitle}} this leave?</ion-card-header>\n\n    <ion-item>\n\n      <ion-label stacked>{{approveTitle}} comments</ion-label>\n\n      <ion-textarea rows=3 columns=12 [(ngModel)]="comment" style="color: #000 !important;">   \n\n      </ion-textarea>\n\n    </ion-item>\n\n\n\n  <p style="text-align: right !important;">\n\n  <span>\n\n    <button ion-button clear (click)="goBack()">No</button>\n\n    <button ion-button clear (click)="approveOrReject()">Yes</button>\n\n  </span>\n\n  </p>\n\n  </ion-card>\n\n\n\n</ion-content>\n\n'/*ion-inline-end:"C:\Users\edot3\Documents\Platica-Polinesia\src\pages\approve-leave-comments\approve-leave-comments.html"*/,
        }),
